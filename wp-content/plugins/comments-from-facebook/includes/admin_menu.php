...
Also, here is another tutorial(from other source) of creating App Id, you can check it - <a style="color:#0073aa" target="_blank" href="https://help.yahoo.com/kb/SLN18861.html">https://help.yahoo.com/kb/SLN18861.html</a>.</p>
                                            ...
                                            <p>Also, you can insert the Facebook Comments box manually in any page, post or even in Php code by using the shortcode, also you can disable comments on single pages or posts.</p>
		...
		<div class="main_parametrs_group_div " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
                    ...
                    <tr>
						<td>
							Comments box width <span title="Type here the Facebook comments box width" class="desription_class">?</span>
						</td>
						<td>
