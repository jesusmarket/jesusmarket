...
$meta_boxes[] = array(
    ...
    'fields' => array( 
		...
		#Event All Day Event
        array(
            'name' => __(' All Day Event', 'imievent-framework-admin'),
   ...
   'pages' => array('post','page','sermons','event','product', 'staff'),
    'fields' => array(
		...
		array(
            ...
            'desc' => __("Default Height is 150.", 'framework'),
            'type' => 'text',
			'default' => '150',
        ),
        array(
...
$meta_boxes[] = array(
    ...
    'fields' => array(
		...
		array(
			'type' => 'heading',
			'name' => __( 'Audio for Sermon', 'meta-box' ),
		...
		array(
			'type' => 'heading',
			'name' => __( 'Video for Sermon', 'meta-box' ),
		...
		array(
			'type' => 'heading',
			'name' => __( 'Additional Media Attachments', 'meta-box' ),
			'desc' => __('These media items will be displayed on single sermon page'),
