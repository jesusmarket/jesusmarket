...
class custom_category extends WP_Widget {
	...
	?>
        ...
        <p>
			<input class="checkbox" type="checkbox" <?php echo $show; ?> id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show'); ?>" /> <label for="<?php echo $this->get_field_id('show'); ?>"><?php _e('Display as dropdown'); ?></label></p>
	<?php
	}
         // update widget
