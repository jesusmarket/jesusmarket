        ...
        <select id="event-type" name="event-type">
            ...
            <option value="past"><?php _e('Past', 'imic-framework-admin'); ?></option>
                        ...
                        ?>
                        	...
                        	<small>This is optional fields to show Google Events in calendar(Max 3 calendar allowed), if left blank then the Google Calendar ID specified at Theme Options > Calendar Options will be used else only WP events will be shown on calendar.</small> <a href="http://support.imithemes.com/forums/topic/setting-up-google-calendar-api-for-events-calendar/" target="_blank"><small>See instructions to get the Calendar ID</small></a>
                        <div class="option">
                        	<label for="calendar_googlecal_id"><?php _e('Google Calendar ID', 'imic-framework-admin'); ?></label>
                            <input type="text" name="calendar_googlecal_id" id="calendar_googlecal_id"/>
                        </div>
                        <div class="option">
                                <label for="calendar-view"><?php _e('Default View', 'imic-framework-admin'); ?></label>
                                <select id="calendar-view" name="calendar-view">
                                    <option value="month"><?php _e('month'); ?></option>
                                    <option value="basicWeek"><?php _e('basicWeek'); ?></option>
                                    <option value="basicDay"><?php _e('basicDay'); ?></option>
                                    <option value="agendaWeek"><?php _e('agendaWeek'); ?></option>
                                    <option value="agendaDay"><?php _e('agendaDay'); ?></option>
                                </select>
                            </div>
                        <div class="option">
                        	<label for="calendar_googlecal_id1"><?php _e('Add. Google Calendar ID', 'imic-framework-admin'); ?></label>
                            <input type="text" name="calendar_googlecal_id1" id="calendar_googlecal_id1"/>
                        </div>
                        <div class="option">
                        	<label for="calendar_googlecal_id2"><?php _e('Add. Google Calendar ID', 'imic-framework-admin'); ?></label>
                            <input type="text" name="calendar_googlecal_id2" id="calendar_googlecal_id2"/>
                        </div>
                        <div class="option">
                                <label for="calender_filter"><?php _e('Filter', 'imic-framework-admin'); ?></label>
                                <select id="calender_filter" name="calender_filter">
                                    <option value="1"><?php _e('Yes'); ?></option>
                                    <option value="0"><?php _e('No'); ?></option>
                                 <p class="info">
								 <?php _e('You can easily choose filter.','imic-framework-admin'); ?>
                                 </p>
                                </select>
                            </div>
                        </div>
