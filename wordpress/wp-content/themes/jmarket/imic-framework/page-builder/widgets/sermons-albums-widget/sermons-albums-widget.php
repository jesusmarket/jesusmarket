...
class Sermons_Albums_Widget extends SiteOrigin_Widget {
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'description' => __('A widget to show categories/albums.', 'imic-framework'),
			...
			array(
				...
				'allpostsbtn' => array(
					'type' => 'text',
					'label' => __('All albums button text', 'imic-framework'),
					'default' => __('All albums', 'imic-framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'imic-framework'),
				),

				'allpostsurl' => array(
					'type' => 'link',
					'label' => __('All albums button URL', 'imic-framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'imic-framework'),
				),
